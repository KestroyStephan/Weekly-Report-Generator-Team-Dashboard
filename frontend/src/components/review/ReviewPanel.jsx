...
export default function ReviewPanel({ report, onSubmitReview, isLoading = false }) {
  ...
  return (
    <>
      <form onSubmit={handlePromptReview} style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <Button
            ...
            isLoading={isLoading}
          >
            {action === 'approve' ? 'Approve Report' : 'Send Correction Request'}
          </Button>
        </div>
      </form>
      ...
      <ConfirmModal
        ...
        title={action === 'approve' ? 'Confirm Report Approval?' : 'Send Correction Request?'}
        message={
          action === 'approve'
            ? 'Are you sure you want to mark this report as Approved? The author will receive a confirmation notification.'
            : 'Are you sure you want to request changes for this report? The author will be notified to make corrections.'
        }
        type={action === 'approve' ? 'success' : 'warning'}
        confirmText={action === 'approve' ? 'Yes, Approve' : 'Yes, Send Request'}
        cancelText="Cancel"
